 ...
 *
 * Gated behind x402 micropayments: $0.001 USDC per lookup.
 * External agents pay via the x402 HTTP payment protocol. Without a valid
 * X-Payment header the endpoint returns HTTP 402 with payment requirements.
 */
scoreRoutes.get(
	"/:address",
	x402Payment({ price: "1000", description: "Qova reputation score breakdown" }),
	validateAddress(),
	async (c) => {
